<?php 
	require_once $_SERVER['DOCUMENT_ROOT'] . '/ti.php';
?>
<!DOCTYPE html> 
<html> 
	<head> 
...
<div data-role="page">
	<div data-role="header">				
		<a href="/public/index.php" data-icon="home" data-iconpos="notext">Home</a>
		<h1><?php startblock('header') ?><?php endblock() ?> - Infected Mushrooms Portal</h1>
		<a href="/login.php" data-ajax="false">Login</a>
		<div data-role="navbar">
			<ul>				
				<li><a href="/public/pubforum-public.php">Forum</a></li>				
				<li><a href="/public/recruits.php">Recruits</a></li>
				<li><a href="/public/members-public.php">Members</a></li>
				<li><a href="/public/treasury.php">Treasury</a></li>
